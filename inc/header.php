        ...
        <div class="header-actions">
            ...
            <?php else: ?>
                ...
                <div class="balance-display">
                    ...
                    <span id="headerSaldo">R$ <?php echo number_format(($usuario ? $usuario['saldo'] : 0), 2, ',', '.'); ?></span>
                </div>
                ...
                <div class="user-dropdown">
                    ...
                    <div id="userDropdownMenu" class="dropdown-menu">
                        ...
                        <button onclick="openWithdrawModal(<?php echo ($usuario ? $usuario['saldo'] : 0);?>)" class="dropdown-item">
...
<aside id="sidebar" class="mobile-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <?php if (isset($_SESSION['usuario_id'])): ?>
            ...
            <button onclick="openWithdrawModal(<?php echo ($usuario ? $usuario['saldo'] : 0);?>)" class="sidebar-item">
                <i class="bi bi-dash-circle"></i>
                <span>Sacar</span>
            </button>
