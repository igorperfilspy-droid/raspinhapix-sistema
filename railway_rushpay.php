<?php
//<?php CLASSE<?php RUSHPAY<?php OTIMIZADA<?php PARA<?php RAILWAY
//<?php Substitua<?php o<?php arquivo<?php classes/RushPay.php<?php original<?php por<?php este
...
<?php 
<?php //<?php Log<?php de<?php inicialização<?php (apenas<?php em<?php desenvolvimento)
<?php if<?php (($_ENV['RAILWAY_ENVIRONMENT']<?php ??<?php 'production')<?php ===<?php 'development')<?php {
<?php error_log("RushPay<?php inicializado<?php na<?php Railway");
<?php }
<?php }
...
<?php //<?php Log<?php para<?php debug<?php (apenas<?php em<?php desenvolvimento)
<?php if<?php (($_ENV['RAILWAY_ENVIRONMENT']<?php ??<?php 'production')<?php ===<?php 'development')<?php {
